...
public final class Pattern
     ...
     * @throws PatternSyntaxException If the expression's syntax is invalid
     */
    public static boolean matches(String regex, CharSequence input) throws EarlyExitException {
     ...
     */
    public String[] split(CharSequence input, int limit) throws EarlyExitException {
        int index = 0;
     ...
     * around matches of this pattern
     */
    public String[] split(CharSequence input) throws EarlyExitException {
    ...
    private static final class BitClass extends BmpCharProperty {
        ...
        boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
            int index = List.of(bits).indexOf(true);
            matcher.getProfile().suggest(pos, index);
    ...
    static class Node extends Object {
         ...
         */
        boolean match(Matcher matcher, int i, CharSequence seq) throws EarlyExitException {
            matcher.getProfile().mark(id);
            matcher.last = i;
    ...
    private static abstract class CharProperty extends Node {
        abstract boolean isSatisfiedBy(Matcher matcher, int pos, int ch);

        CharProperty complement() {
            return new CharProperty() {
                boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                    return !CharProperty.this.isSatisfiedBy(matcher, pos, ch);
                }
            };
        }
        ...
        boolean match(Matcher matcher, int i, CharSequence seq) throws EarlyExitException {
            ...
            if (i < matcher.to) {
                ...
                return isSatisfiedBy(matcher, i, ch)
    ...
    private static abstract class BmpCharProperty extends CharProperty {
        boolean match(Matcher matcher, int i, CharSequence seq) throws EarlyExitException {
            matcher.getProfile().mark(id);
            if (i < matcher.to) {
                return isSatisfiedBy(matcher, i, seq.charAt(i))
    ...
    static final class SingleS extends CharProperty {
        ...
        boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
            matcher.getProfile().suggest(pos, c);
            return ch == c;
        }
    }
    ...
    static final class SingleI extends BmpCharProperty {
        ...
        boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
            matcher.getProfile().suggest(pos, lower); // Either is OK
    ...
    static final class Block extends CharProperty {
        ...
        boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
            matcher.getProfile().suggest(
                    pos,
                    Character.UnicodeBlock.getBlockStart(block));
    ...
    static final class Script extends CharProperty {
        ...
        boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
            matcher.getProfile().suggest(
                    pos,
                    Character.UnicodeScript.getScriptStart(script));
    ...
    static final class VertWS extends BmpCharProperty {
        boolean isSatisfiedBy(Matcher matcher, int pos, int cp) {
            matcher.getProfile().suggest(pos, 0x0A);
    ...
    static final class HorizWS extends BmpCharProperty {
        boolean isSatisfiedBy(Matcher matcher, int pos, int cp) {
            matcher.getProfile().suggest(pos, 0x20);
    ...
    private static CharProperty rangeFor(final int lower,
        ...
        return new CharProperty() {
            boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                matcher.getProfile().suggest(pos, lower);
    ...
    static final class Dot extends CharProperty {
        boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
            matcher.getProfile().suggest(pos, 'A');
            return (ch != '\n' && ch != '\r'
                    && (ch | 1) != '\u2029'
                    && ch != '\u0085');
        }
    ...
    static final class Curly extends Node {
        ...
        boolean match0(Matcher matcher, int i, int j, CharSequence seq) throws EarlyExitException {
            if (j >= cmax) {
        ...
        // i is the index to start matching at
        // j is the number of atoms that have matched
        boolean match1(Matcher matcher, int i, int j, CharSequence seq) throws EarlyExitException {
            for (; ; ) {
        ...
        boolean match2(Matcher matcher, int i, int j, CharSequence seq) throws EarlyExitException {
            for (; j < cmax; j++) {
                if (!atom.match(matcher, i, seq))
                    break;
                if (i == matcher.last)
    ...
    static final class GroupHead extends Node {
        ...
        boolean matchRef(Matcher matcher, int i, CharSequence seq) throws EarlyExitException {
            matcher.getProfile().mark(id);
            int save = matcher.locals[localIndex];
    ...
    static class Loop extends Node {
        ...
        boolean matchInit(Matcher matcher, int i, CharSequence seq) throws EarlyExitException {
            matcher.getProfile().mark(id);
    ...
    private static CharProperty union(final CharProperty lhs,
        ...
        return new CharProperty() {
            boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                return lhs.isSatisfiedBy(matcher, pos, ch)
                        || rhs.isSatisfiedBy(matcher, pos, ch);
            }
        };
    }
    ...
    private static CharProperty setDifference(final CharProperty lhs,
        ...
        return new CharProperty() {
            boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                return !rhs.isSatisfiedBy(matcher, pos, ch)
                        && lhs.isSatisfiedBy(matcher, pos, ch);
            }
        };
    }
     ...
     * can are also part of a word if they have a rengar.base character, otherwise
     ...
     * if they have a rengar.base character.
     */
    ...
    private static class CharPropertyNames {
        ...
        static {
            ...
            defClone("javaIdeographic", new CloneableProperty() {
                boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                    matcher.getProfile().suggest(pos, 0x738B);
                    return Character.isIdeographic(ch);
                }
            });
            defClone("javaTitleCase", new CloneableProperty() {
                boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                    matcher.getProfile().suggest(pos, 0x01f2);
                    return Character.isTitleCase(ch);
                }
            });
            defClone("javaDigit", new CloneableProperty() {
                boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                    matcher.getProfile().suggest(pos, '0');
            ...
            defClone("javaSpaceChar", new CloneableProperty() {
                boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                    matcher.getProfile().suggest(pos, ' ');
            ...
            defClone("javaISOControl", new CloneableProperty() {
                boolean isSatisfiedBy(Matcher matcher, int pos, int ch) {
                    matcher.getProfile().suggest(pos, 0x1c);
