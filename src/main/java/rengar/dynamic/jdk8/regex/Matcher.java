...
public final class Matcher implements MatchResult {
     ...
     */
    public boolean matches() throws EarlyExitException {
     ...
     */
    public boolean find() throws EarlyExitException {
     ...
     */
    public boolean find(int start) throws EarlyExitException {
     ...
     * sequence matches this matcher's pattern
     */
    public boolean lookingAt() throws EarlyExitException {
     ...
     * as needed
     */
    public String replaceAll(String replacement) throws EarlyExitException {
        reset();
        boolean result = find();
        if (result) {
            StringBuffer sb = new StringBuffer();
     ...
     */
    public String replaceFirst(String replacement) throws EarlyExitException {
        if (replacement == null)
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("java.rengar.util.regex.Matcher");
     ...
     */
    boolean search(int from) throws EarlyExitException {
        this.hitEnd = false;
     ...
     */
    boolean match(int from, int anchor) throws EarlyExitException {
        this.hitEnd = false;
        this.requireEnd = false;
        from = from < 0 ? 0 : from;
        this.first = from;
