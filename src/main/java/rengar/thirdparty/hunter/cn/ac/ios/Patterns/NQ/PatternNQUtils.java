package rengar.thirdparty.hunter.cn.ac.ios.Patterns.NQ;
...
import rengar.thirdparty.hunter.cn.ac.ios.Utils.DkBricsAutomatonUtils;
...
//                System.out.println("child.getData() = " + child.getData());
                    ...
                    for (TreeNode generalizedCountingNode : allGeneralizedCountingNode) {
                        ...
                        if (BracketUtils.isInLookAroundNode(generalizedCountingNode)) continue;
...
//                        String infix = getInfixForNQwithLookAround(node, generalizedCountingNode);
                            ...
                            String prefix1 = DkBricsAutomatonUtils.getPrefixString(standardizedReDoSTree, generalizedCountingNode, true); // 获取的是前缀正则+中缀正则的生成串
                            String prefix2 = DkBricsAutomatonUtils.getPrefixString(standardizedReDoSTree, generalizedCountingNode, false);
...
//                            if (specialSuffixStringWithCountingAndEndLine != null) suffixSet.add(specialSuffixStringWithCountingAndEndLine);
                            ...
                            for (String infix : infixSet) {
                                suffixSet.addAll(DkBricsAutomatonUtils.getSuffixString(standardizedReDoSTree, generalizedCountingNode, infix));
