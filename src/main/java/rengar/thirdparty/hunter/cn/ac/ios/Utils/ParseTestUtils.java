...
import static rengar.thirdparty.hunter.cn.ac.ios.Utils.RegexUtils.removeBlankStr;
...
public class ParseTestUtils {
    private static TreeNode getReDoSTree(String regex, String language) throws InterruptedException {
        ...
        // 最开头的预处理
        regex = Utils.rewriteRegex(regex);
        ...
        // 建树
        TreeNode ReDoSTree = Utils.createReDoSTree(regex, language);
        ...
        // 删除Flags
        ReDoSTree = FlagsUtils.getNodeByRemoveRegExpFlag(ReDoSTree);

        ReDoSTree = FlagsUtils.getNodeByRemoveLocalFlag(ReDoSTree);
    ...
    private static String getParseResult(String regex, String language) {
        ...
        try {
            ...
            Utils.walk1(ReDoSTree, builder1);
        } catch (Exception e) {
            return null;
        }
