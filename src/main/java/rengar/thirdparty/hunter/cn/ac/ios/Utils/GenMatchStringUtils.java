...
import rengar.thirdparty.hunter.dk.brics.automaton.State;
...
import static rengar.thirdparty.hunter.cn.ac.ios.Utils.BracketUtils.isInLookAroundNode;
...
//            String regex = repairLineFeedsCarriageReturnsAndTabCharacters(regexList.get(i));
            ...
            Automaton automaton = DkBricsAutomatonUtils.getAutomaton(regex);
