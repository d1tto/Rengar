...
import rengar.thirdparty.hunter.cn.ac.ios.Bean.Attack;
import rengar.thirdparty.hunter.cn.ac.ios.Bean.AttackBean;
import rengar.thirdparty.hunter.cn.ac.ios.Bean.Output;
import rengar.thirdparty.hunter.cn.ac.ios.Bean.ReDoSBean;
import rengar.thirdparty.hunter.cn.ac.ios.Utils.multithread.ITask;
import rengar.thirdparty.hunter.cn.ac.ios.Utils.multithread.MultiBaseBean;
import rengar.thirdparty.hunter.cn.ac.ios.Utils.multithread.MultiThreadUtils;
...
import static rengar.thirdparty.hunter.cn.ac.ios.Utils.Utils.readFile;
...
public class Test {
    public static void main(String[] args) throws IOException {
        String filePath = Test.class.getResource("/php").getPath();
        String fileName = "php_regex_new-part0-disturb.txt";
            ...
            if (bean.isReDoS()) {
                ...
                for (int i = 0; i < bean.getAttackBeanList().size(); i++) {
                    if (bean.getAttackBeanList().get(i).isAttackSuccess()) {
                        ...
                        if ((model.equals(Main.ATTACK_MODEL_SINGLE) && flag) || model.equals(Main.ATTACK_MODEL_MULTI)) {  // 修改
