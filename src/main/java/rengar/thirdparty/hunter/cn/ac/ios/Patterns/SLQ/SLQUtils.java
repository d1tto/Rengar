...
public class SLQUtils {
    ...
    public static boolean isSLQCountingNode(TreeNode node) {
        ...
        if (node.getChildCount() == 2) {
            if (Pattern.matches(Constant.EXTENDED_COUNTING, node.getChild(1).getData())) {
    ...
    public static boolean isSLQThreeCountingNode(TreeNode node) {
        if (isGroupNode(node)) {
            ...
            if (node.getChildCount() == 2 && Pattern.matches(Constant.EXTENDED_COUNTING, node.getChild(1).getData())) {
    ...
    public static int getMatchLength(TreeNode root) {
        if (isGroupNode(root)) {
            ...
            if (data.length() == 1 && FlagsUtils.isSpecialCharacter(data.charAt(0))) {
                return 0;
        ...
        } else if (BracketUtils.isBracketsNode(root)) {
            return 1;
...
//            }
                ...
                if (("\\w").equals(data)) {
                    ArrayList<String> list = new ArrayList<>(Arrays.asList(Constant.w_MATCH_CHARACTER_LIST));
                    arrayLists.add(list);
                } else if (("\\s").equals(data)) {
                    ArrayList<String> list = new ArrayList<>(Arrays.asList(Constant.s_MATCH_CHARACTER_LIST));
                    arrayLists.add(list);
                } else if (("\\d").equals(data)) {
                    ArrayList<String> list = new ArrayList<>(Arrays.asList(Constant.d_MATCH_CHARACTER_LIST));
                    arrayLists.add(list);
                } else if ((".").equals(data)) {
