...
import rengar.thirdparty.hunter.cn.ac.ios.JavaRegex.JavaRegexBuilder;
import rengar.thirdparty.hunter.cn.ac.ios.JavaRegex.JavaRegexParser;
import rengar.thirdparty.hunter.cn.ac.ios.JavaScriptRegex.JavaScriptRegexBuilder;
import rengar.thirdparty.hunter.cn.ac.ios.JavaScriptRegex.JavaScriptRegexParser;
...
import rengar.thirdparty.hunter.cn.ac.ios.Bean.RegexBean;
import rengar.thirdparty.hunter.cn.ac.ios.PythonRegex.PythonRegexBuilder;
import rengar.thirdparty.hunter.cn.ac.ios.PythonRegex.PythonRegexParser;
...
//		System.out.println(root.data + "\t" + level);
    ...
    public static String deleteGroupNameForNoQuote(String regex) {
        Matcher matcher = Constant.pattern_groupNameRegexForNoQuote.matcher(regex);
...
//    }
    ...
    public static String deleteGroupName(String regex) throws InterruptedException {
        ...
        while (!queue.isEmpty()) {
            ...
            Matcher matcher = Constant.pattern_groupNameRegexForReDoSTreeNode.matcher(node.getData());
            if (matcher.find()) {
    ...
    public static String deleteNonGreedyMatching(String regex) {
        Matcher matcher = Constant.pattern_nonGreedyMatching.matcher(regex);
    ...
    public static String rewritePOSIXCharacterClass(String regex) {
        Matcher matcher = Constant.pattern_posixCharacterClass.matcher(regex);
...
//		engine.eval(readJSFile("src/main/java/rengar.util/prism.js"));
...
//        }
    ...
    public static String rewriteCounting(String regex) {
        ...
        // 处理{,4}这种counting
        Matcher matcher = Constant.pattern_specialCountingRegex.matcher(regex);
...
//        System.out.println(subregex);
    ...
    public static String serializeRegex(TreeNode treeNode, Map<String, String> sereializeMap) throws InterruptedException {
        ...
        alphabet = BracketUtils.simplifyLetters(alphabet, Constant.SimplyLevel.LOW);
...
//        printTree(ReDoSTreeWithComma);
        ...
        while (!stack.isEmpty()) {
            ...
            if (BracketUtils.isBracketsNode(node) && node.getData().length() == 5) {
...
//        return sb.toString();
    ...
    public static String deleteAnnotation(String regex) {
        Matcher matcher = Constant.pattern_annotationRegex.matcher(regex);
    ...
    public static TreeNode createReDoSTree(String regex, String language) throws InterruptedException {
        ...
        if (language.equals("java")) {
            RegexBean regexBean = FlagsUtils.divideRegexByFlags(regex);
